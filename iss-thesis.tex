...
\def \enworktitle{6 DoF Pose Esitmation with Diffusion Models from single RGB-D Image}        % English title/translation
...
\subsubsection{Feature Fusion}\label{sec:fusion}
