...
Mathematically, condition means the prior distribution $p(\mathbf{x})$ is conditioned on a given input $y$. Modifiy the equation \ref{eq:reverse_all}, we get
\begin{align}
